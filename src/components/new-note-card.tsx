...
export function NewNoteCard({ onNoteCreated }: NewNoteCardProps) {
  const [shouldDhowOnboarding, setShouldOnboarding] = useState(true);
  ...
  function handleStartRecording() {
    ...
    if (!isSpeechRecognitionAPIAvailable) {
      alert("Infelizmente o seu navegador não suporta API de gravação!");
      return;
    }
  ...
  return (
    <Dialog.Root>
      <Dialog.Trigger
        className="rounded-md flex flex-col bg-slate-700 p-5 text-left gap-3 outline-none hover:ring-2 hover:ring-slate-600 
